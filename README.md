...
- Live weather data with recommendations
...
WEATHER_API_KEY	✅ Yes	Weather tool
MEM0_API_KEY	❌ Optional	Persistent memory

If MEM0_API_KEY is missing, the agent continues without memory.
...
Includes practical recommendations (clothing advice)
...
Rotates automatically (5MB per file, 5 backups)
